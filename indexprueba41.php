...
<div class="tab">
  ...
  <button class="tablinks" onclick="openCity(event, 'd0')" id="defaultOpen"><img src="../img/iconos/serviciose.png" width="32px" style="vertical-align:middle;"> Ultimas Entradas</button>
  <button class="tablinks" onclick="openCity(event, 'd1')" id="defaultOpen"><img src="../img/iconos/incidencias.png" width="32px" style="vertical-align:middle;"> Ultimas Incidencias</button>
...
<div id="d0" class="tabcontent">
  <h3><img src="../img/iconos/serviciose.png" width="32px" style="vertical-align:middle;"> Ultimas Entradas</h3>
...
<div id="d1" class="tabcontent">
  <h3><img src="../img/iconos/incidencias.png" width="32px" style="vertical-align:middle;"> Ultimas Incidencias</h3>
