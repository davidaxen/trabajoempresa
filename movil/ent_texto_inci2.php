...
$gt="idempresa-".$valores1."-ent_texto_inci2";
...
$sql18="SELECT * from vecinos,vecinoscom where vecinos.idcliente=vecinoscom.idcliente and vecinos.idempresa=vecinoscom.idempresa and vecinoscom.idcliente='".$idcomunidad."' and vecinoscom.idempresa='".$idempresa."' and incidencia='1' and estado='1'";
//echo $sql18;
