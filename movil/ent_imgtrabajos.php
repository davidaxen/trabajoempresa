...
$gt="idempresa-".$valores1."-imgtrabajos";
...
$sql1="SELECT * from imgtrabajos where idempresa='".$idempresa."' and idsiniestro='".$num_siniestro."' order by idimgsiniestro desc"; 
$result1=mysqli_query ($conn,$sql1) or die ("Invalid result 1");
$row=mysqli_num_rows($result1);

if ($row!=0){;
$resultado1=mysqli_fetch_array($result1);
$idimgsiniestro=$resultado1['idimgsiniestro'];
...
$rf1=$idempresa."-".$idimgsiniestro."-".$num_siniestro."t-".$dia2.".".$tipoimagen;
$dat2[0]=$rf1;
...
$sql1 = "INSERT INTO imgtrabajos (idempresa,idempleado,idsiniestro,idimgsiniestro,imgsiniestro,texto,dia,hora,lon,lat,taccion) VALUES 
