...
$gt="idempresa-".$valores1."-lis_acc_mante";
...
$sql1 = "SELECT * from codservicios where idempresas='".$idempresa."' and  idclientes='".$idclientes."' and  idpccat='4' and activo='1' order by idpcsubcat asc";
...
$sql11 = "SELECT * from puntservicios where idempresas='".$idempresa."' and  idpccat='4' and  idpcsubcat='".$idpcsubcat."'";
