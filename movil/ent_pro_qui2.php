...
$gt="idempresa-".$valores1."-ent_pro_qui2";
...
$sql1 = "INSERT INTO almpc (idempresas,idempleado,idpiscina,idpccat,idpcsubcat,dia,hora,lat,lon,cantidad) VALUES ('$idemprempl','$idempl','$idpis','$idcat','$idsubcat','$diaa','$hora','$lat','$lon','$val')";
//echo $sql1;
