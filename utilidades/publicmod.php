...
<body>
<table>
<tr><td rowspan="2"><img src="../img/<?=$img;?>" height=80></td><td class="enc">MODIFICACIÓN DE CAMPAÑAS</td></tr>
...
<table>
<form method="post" action="publicmod.php">
...
?>
<table>
<tr class="subenc"><td>Titulo</td><td>Imagen</td><td>Documento PDF</td><td>Modificar</td></tr>
<? for ($i=0; $i<$row; $i++){;?>
...
<td><a href="publicmod2.php?id=<?=$id;?>"><img src="../img/modificar.gif" alt="modificar" border=0 width=20></a></td>
