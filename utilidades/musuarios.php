...
?>
<table>
<tr class="subenc"><td>Cod Usuario</td><td>Nombre</td><td>Opcion</td></tr>
<? for ($i=0; $i<$row; $i++){;?>
<tr class="menor1">
...
<td><a href="modusuarios.php?user1=<?=$user1;?>"><img src="../img/modificar.gif" alt="modificar" border=0 width=20></a></td>
</tr>
<?};?>
</table>
