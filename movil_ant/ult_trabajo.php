...
$sql1 = "SELECT * from trabajos where idempresa='".$idempresa."' and  idempleado='".$idempleado."' and terminado='1' order by diaasignacion asc, horaasignacion asc, id desc limit ".$valor.", 5";
//echo $sql1;
