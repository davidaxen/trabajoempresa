...
$sql="select * from acctrabajos where idempresa='87' and diasalida='".$fechahoy."' and trabajorealizado='0'";
//echo $sql."<br/>";
...
$descript=$resuladott['descripcion'];
...
$sql1 = "update acctrabajos set descripcion='".$descript."', trabajopendiente='".$texto."', trabajorealizado='".$descrip."' where id='".$idd."'";
...
$sql1 = "update acctrabajos set descripcion='".$descript."', trabajopendiente='0', trabajorealizado='".$descrip."' where id='".$idd."'";
//INSERT INTO acctrabajos (idempresa,idsiniestro,descripcion,diaentrada,horaentrada) VALUES ('87','$ids','$texto','$diaahora','$horaahora')";
//echo $sql1."<br/>";
$result1=mysqli_query($conn,$sql1) or die ("Invalid result 1");
