...
$sql22="SELECT * from clientes where idempresas='".$ide."' and idclientes='".$idaseguradora."'";
$result22=mysqli_query($conn,$sql22) or die ("Invalid result");
$resultado22=mysqli_fetch_array($result22);
$nombref=$resultado22['nombre'];

$diaapertura=$y.'-'.$m.'-'.$d;
$horaapertura=$hora.':'.$min.':'.$seg;

$descripcion=$productos.'-und:'.$unidades;
...
VALUES ('$ide','$idsiniestro','$numsiniestro','$idaseguradora','$nombref','$telcontacto','$dircontacto','$loccontacto','$procontacto','$cpcontacto','$mailcontacto','$descripcion','0','$diaapertura','$horaapertura','$lat1','$lon1')";
//echo $sql1;
