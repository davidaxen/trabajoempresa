...
<input type="hidden" name="diaasig" value="<?=$diaasig;?>">
<input type="hidden" name="horaasig" value="<?=$horaasig;?>">
...
<tr><td>
<table>
<tr><td>Trabajador</td><td><?=$nombre;?>, <?=$priapellido;?> <?=$segapellido;?></td></tr>
<tr><td>Trabajo Realizado</td><td><?=$trabajor;?></td></tr>
<tr><td>Trabajo Pendiente</td><td><?=$trabajop;?></td></tr>
</table>
</td></tr>
<?};?>
<?};?>
...
<tr><td>Dia</td><td><input type="text" name="d" size="2" value="<?=$dant;?>">-<input type="text" name="m" size="2" value="<?=$mant;?>">-<input type="text" name="y" size="4" value="<?=$yant;?>"></td></tr>
<tr><td>Hora</td><td><input type="text" name="hora" size="2" value="<?=$hant;?>">-<input type="text" name="min" size="2" value="<?=$minant;?>">-<input type="text" name="seg" size="2" value="<?=$segant;?>"></td></tr>
