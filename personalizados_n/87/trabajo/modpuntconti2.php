...
<input type="hidden" name="cantpuntcont" value="<?=$cantpuntcont;?>">
...
?>
<tr><td colspan="2"><input type="hidden" name="punt[<?=$t?>]" value="<?=$idpcsubcat;?>"><?=$subcategoria;?></td></tr>
<?};?>
<?}else{;?>
...
$subcategoria=$resultado2['subcategoria'];
?>
<option value="<?=$idpcsubcat;?>"><?=$subcategoria;?>
<?};?>
<?};?>
</td></tr>
<?};?>
