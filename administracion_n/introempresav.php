...
$sql3 = "INSERT INTO administrar (idempresa,clientes,gestores,
empleados,empresas,empresa,usuario,visita,proveedor,puestos,vecinos) 
VALUES ('$idempresas','$datosan[0]','$datosan[1]','$datosan[2]','$datosan[3]','$datosan[4]','$datosan[5]','$datosan[6]','$datosan[7]','$datosan[8]','$datosan[9]')";
//echo $sql3.'<br/>';
