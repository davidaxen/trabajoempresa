...
<body class='html' style='background-image:url(../img/iconos/aemme-fondo.png);
...
<div class='hijo' style='background-color:#f5f5f5'>
  ...
  <div class='imgcontainer'>
    <img src='../img/nativetab2.png' width='250px'>
...
$asunto="ALTA DE SERVICIO EN NATIVECBC";
$href="https://control.nativecbc.com/administracion_n/activacion1.php?".$codvalidarinc;
    ...
    $subject = $asunto;
		...
		$message = "
				...
				<body><center>
				<table>
				<tr><td colspan='3' align='center'><img src='https://control.nativecbc.com/img/nativetab2.png' width='250px'></td></tr>
				<tr><td colspan='3' >Bienvenidos al Portal de NATIVECBC</td></tr>
				<tr><td colspan='3' >Hola $nombremp2 :</td></tr>
				<tr><td colspan='3' >Bienvenidos al Portal de NATIVECBC, a continuaci&oacute;n le indicamos los datos de acceso</td></tr>
...
en http://www.nativecbc.com. Este documento est&aacute; dirigido exclusivamente al destinatario especificado. 
...
distribuci&oacute;n, impresi&oacute;n o copia de toda o alguna parte de la informaci&oacute;n contenida.
    ...
    $headers = 'From: NATIVECBC - LA SOLUCION COMPLETA PARA LA GESTIÓN DE PERSONAL - <info@nativecbc.com>' . $eol;
if ($emailadmin2!=""){;   
    $headers .= 'Cc: '.$emailadmin2  . $eol;
};

	 $headers .= 'Bcc: nativecbc@yahoo.com'  . $eol;
