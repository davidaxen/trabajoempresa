...
if (count($cqri)!=$valorcqr){;?>
	<div class="main">
		<span class="caja2"><b>Tareas Frecuentes</b></span>
		<?php  

		for ($j=0;$j<count($cqri);$j++){;?>
		<?php 
		if ($cqri[$j]=='1'){;?><a href="<?php  echo $encqri[$j];?>?dat=i"><span class="caja"><img src="../../img/<?php  echo $icqri[$j];?>" width="64px"><br/><?php  echo $ncqri[$j];?></span></a><?php };?>
		<?php
...
<?php if (count($cpi)!=$valorcp){;?>
<div class="main">
<span class="caja2"><b>Tareas Programadas</b></span>
<?php  for ($j=0;$j<count($cpi);$j++){;?>
...
<?php if (count($cci)!=$valorcc){;?>
<div class="main">
<span class="caja2"><b>Comunicaciones</b></span>
<?php  for ($j=0;$j<count($cci);$j++){;?>
...
<?php if (count($cai)!=$valorca){;?>
<div class="main">
<span class="caja2"><b>Avisos de Asistencia</b></span>
<?php  for ($j=0;$j<count($cai);$j++){;?>
