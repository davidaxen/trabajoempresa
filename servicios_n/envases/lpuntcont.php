...
<table>
<tr>
<td>Imprimir c&oacute;digos del <?php  echo $valor1;?> al <?php  echo $valor2;?></td>
<td>
<a href="dymo2.php?enviar=enviar&valor1=<?php  echo $valor1;?>&valor2=<?php  echo $valor2;?>">
<img src="../../img/dymo.png" width="25px">
</a></td></tr>
</td>
</tr>
</table>
...
<td><a href="dymo.php?enviar=enviar&idenvases=<?php  echo $idenvases;?>"><img src="../../img/dymo.png" width="25px"></a></td></tr>
<?php };?>
</table>
