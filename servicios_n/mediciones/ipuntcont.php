...
<td><?php if ($activo==1){;?>Si<?php }else{;?>No<?php };?>
</td>
<td><a href="mpuntcont.php?enviar=enviar&subcategoria=<?php  echo $subcategoria;?>&idpcsubcat=<?php  echo $idpcsubcat;?>&activo=<?php  echo $activo;?>&rellr=<?php  echo $rellr;?>&rellg=<?php  echo $rellg;?>&rellb=<?php  echo $rellb;?>">
<img src="../../img/pencil.png" width="25px"></a></td>
...
<img alt="volver" border="0" src="../../img/iconos/volver-g.png" width="32px" onclick="history.back()">
