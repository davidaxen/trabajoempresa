...
<body>
<table>
<tr><td><img src="../../img/<?php  echo $img;?>"  height=80></td>
...
$resultado0=mysqli_fetch_array($result);
...
$sql11="select idempleado, nombre, 1apellido as pa, 2apellido as sa from empleados where idempresa='".$ide."'";
...
$idce=$resultado11['idempleado'];
$nombree=$resultado11['nombre'];
$apellidope=$resultado11['pa'];
$apellidose=$resultado11['sa'];
?>
