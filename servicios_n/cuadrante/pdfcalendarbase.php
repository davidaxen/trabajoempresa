...
function printMonth($date)
{
	...
	$date_info1 = gmdate ("F", jdtounix($date));
switch ($date_info1) { 
...
case "December" : $mes_info="Diciembre";break; 
	...
	$monthStr= strtoupper($mes_info.' '.$year);
	
	$this->SetXY($this->lMargin,$this->tMargin);
	$this->SetFont("Times", "B", $this->headerFontSize);
	$this->Cell($width, $firstLine, $monthStr, 0,0, "R");
	...
	for ($i = 1; $i <= 7; ++$i)
		...
		//$day = gmdate("l", jdtounix($this->MDYtoJD(2,$i,2009)));
			$date_info2 = gmdate("l", jdtounix($this->MDYtoJD(2,$i,2009)));
switch ($date_info2) { 
case "Monday" : $dia_info="Lunes";break; 
case "Tuesday" : $dia_info="Martes";break; 
case "Wednesday" : $dia_info="Miercoles";break; 
case "Thursday" : $dia_info="Jueves";break; 
case "Friday" : $dia_info="Viernes";break; 
case "Saturday" : $dia_info="Sabado";break; 
case "Sunday" : $dia_info="Domingo";break; 
};
		$day=$dia_info;
		//$day="hola";
