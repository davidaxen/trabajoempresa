...
if($day_heading_length > 0 and $day_heading_length <= 8){ 
$calendar .= "<tr>\n"; 
...
($day_heading).
//($day_heading_length != 8 ? substr($day_heading, 0, $day_heading_length) : $day_heading). 
...
$sql.=" and dia='".$fecha_b."'";
if ($idclientes!='todos'){
$sql.=" order by dia asc, hora asc, idempleado asc, id asc";
}else{
$sql .=" order by id asc";
 }
//echo $sql;
...
$calendar .= strtoupper($nempleado)."</font><hr align='center'>";
