...
<?php 
function CalendarioPHP($year, $month, $day_heading_length = 3,$idempresa2,  $idruta2  ){ 
global $lat;
global $long;
global $offset;
global $zenith;
...
switch($diasemana){;
case 1:$sqlds=" and lun='1'";break;
case 2:$sqlds=" and mar='1'";break;
case 3:$sqlds=" and mie='1'";break;
case 4:$sqlds=" and jue='1'";break;
case 5:$sqlds=" and vie='1'";break;
case 6:$sqlds=" and sab='1'";break;
case 7:$sqlds=" and dom='1'";break;
};
...
$calendar .= "</font></a><hr align='center'>";
...
for($j=1; $j<13; $j++){;
$mes=$j;
echo CalendarioPHP($yea, $mes, $dia,$ide,  $idruta  ); 
};
}else{;
echo CalendarioPHP($yea, $mes, $dia,$ide,  $idruta  ); 
};
