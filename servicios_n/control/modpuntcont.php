...
<div id="main">
<div class="titulo">
<p class="enc">MODIFICACION DE SINIESTROS</p></div>
<div class="contenido">
<?php 
...
foreach ($result as $row) {
	$nombre=$row['aseguradora'];
	$idaseg=$row['idaseguradora'];
//for ($t=0;$t<$row2;$t++){;
...
<tr><td colspan="2"><textarea name="descripcion1" cols="50" rows="8"><?php  echo $descripcion;?></textarea></td></tr>
<tr><td>Dia Apertura</td><td><input type="text" maxlength="2" size="2" name="d" value="<?php  echo $d;?>">-
