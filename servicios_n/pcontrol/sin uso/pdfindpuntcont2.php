...
$idclientes=mysql_result($result2,0,'idclientes');
...
$title1=$nombre;
if (($descrip=="COMIENZO DE RONDA") or ($descrip=="FIN DE RONDA")){;
$title2=$descrip;
}else{;
...
$pdf->SetXY(20,$p2);
$pdf->MultiCell(67,4,strtoupper($title2),0,'J',0);
...
$pdf->EAN13(115,$p2,$codigo,10,0.6);
