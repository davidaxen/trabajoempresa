...
$sql="SELECT * from almpcronda where idempresas='".$ide."' and idcliente='".$idclientes."' and idronda='c' ";
/*
if ($idpunt!='todos'){
...
$calendar .= "<a href='ipcdhora.php?idpcronda=".$idpcronda."&hora=".$hora."&d=".$day."&m=".$month."&y=".$year."&idclientes=".$idclientes."&ide=".$ide."'>";
$calendar .=$hora;
