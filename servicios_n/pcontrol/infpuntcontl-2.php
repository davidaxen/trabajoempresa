...
<div id="main">
<div class="titulo">
<p class="enc">INFORME DE PUNTOS DE <?php  echo strtoupper($nc);?></p></div>
<div class="contenido">
<?php 
if ($tipo=="dia"){;
...
$sql="SELECT * from almpcronda where idempresas='".$ide."' and idcliente='".$idclientes."' and idronda='c' and dia='".$fechaa."'";
//echo $sql;
...
<td><a href="ipcdhora.php?idpcronda=<?php  echo $idpcronda;?>&hora=<?php  echo $hora;?>&d=<?php  echo $d;?>&m=<?php  echo $m;?>&y=<?php  echo $y;?>&idclientes=<?php  echo $idclientes;?>&ide=<?php  echo $ide;?>">
<?php  echo $hora;?>
</a>
