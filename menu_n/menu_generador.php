...
<?php if (count($cqr)!=$valorcqr){;?>
<div class="main">
<span class="caja2"><b>Tareas Frecuentes</b></span>
<?php  for ($j=0;$j<count($cqr);$j++){;?>
<?php if ($cqr[$j]=='1'){;?><a href="<?php  echo $encqr[$j];?>?dat=h"><span class="caja"><img src="../img/<?php  echo $icqr[$j];?>" width="64px"><br/>
	<?php  echo $ncqr[$j]; ?></span></a><?php };?>
<?php };?>
</div>
<?php };?>

<?php if (count($cp)!=$valorcp){;?>
<div class="main">
<span class="caja2"><b>Tareas Programadas</b></span>
<?php  for ($j=0;$j<count($cp);$j++){;?>
<?php if ($cp[$j]=='1'){;?>
