...
<div id="main">
<div class="titulo">
<p class="enc"><?php  echo strtoupper($nc);?> DE TRABAJO DE EMPLEADOS</p></div>
<div class="contenido">
...
<input type="hidden" name="tablas" value="jorempleados">
...
<td>
<select name="horsaldf[<?php  echo $h;?>]">
<option value=""></option>
<?php for ($hj=0;$hj<24;$hj++){;?>
<option value="<?php  echo $hj;?>:00"><?php  echo $hj;?>:00</option>
<option value="<?php  echo $hj;?>:15"><?php  echo $hj;?>:15</option>
...
<td>
<select name="margensaldf[<?php  echo $h;?>]">
<option value=""></option>
<option value="00:05">00:05</option>
<option value="00:10">00:10</option>
</select>
...
<option value="1" checked>Activo
<option value="2">Vacaciones
<option value="3">Baja
</select>
</td>
<td>
<select name="horent[<?php  echo $j;?>]">
<option value=""></option>
<?php for ($hj=0;$hj<24;$hj++){;?>
<option value="<?php  echo $hj;?>:00"><?php  echo $hj;?>:00</option>
<option value="<?php  echo $hj;?>:15"><?php  echo $hj;?>:15</option>
...
<td>
<select name="margenent[<?php  echo $j;?>]">
<option value=""></option>
<option value="00:05">00:05</option>
<option value="00:10">00:10</option>
</select>
...
<td>
<select name="margensal[<?php  echo $j;?>]">
<option value=""></option>
<option value="00:05">00:05</option>
<option value="00:10">00:10</option>
</select>
