...
$idclientevec=$resultado33['idclientes'];
$nombrevec=$resultado33['nombre'];
?>
...
<tr><td class="tit">
<input type="checkbox" name="incidenciatt" value="1" <?php if($incidenciat==1){;?>checked<?};?> disable  >
</td><td>
<input type="checkbox" name="jornadatt" value="1" <?php if($jornadat==1){;?>checked<?};?> disable  >
</td></tr>
