...
<div id="main">
<div class="titulo">
<p class="enc">MODIFICACION <?php  echo strtoupper($nc);?> DE TRABAJO DE EMPLEADOS</p></div>
<div class="contenido">
<?php 
$enviar="enviar";
$estado="1";
...
<td><a href="mjorempleados.php?idempleado=<?php  echo $idempleado;?>"><img src="../img/pencil.png" alt="modificar" border=0 width=20></a></td>
</tr>
<?php };?>
</table>
