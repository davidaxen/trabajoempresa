...
<?php 
if ($enviar==null){;?>
<form action="ljretempleados.php" method="post" name="form2">
...
<td><a href="ljorretempleados.php?idempleado=<?php  echo $idempleado;?>"><img src="../img/modificar.gif" alt="modificar" border=0 width=20></a></td>
</tr>
<?php };?>
</table>
