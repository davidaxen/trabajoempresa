...
$estado="1";
if ($enviar==null){;?>
<form action="jclientes.php" method="post" name="form2">
...
<td><a href="jorclientes.php?idclientes=<?php  echo $idclientes;?>"><img src="../img/modificar.gif" alt="modificar" border=0 width=20></a></td>
</tr>
<?php };?>
</table>
