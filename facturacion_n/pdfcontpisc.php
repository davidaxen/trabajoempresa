...
$dato[]=$resultado31['productos'];
$dato[]=$resultado31['niveles'];
...
$dato2[]=$resultado31['productos'];
$dato2[]=$resultado31['niveles'];


//$dato[]=mysqli_result($result,0,'trabajo');
$row=count($valores);
