...
<?php if ($estadoe==1){;?>
<td width="150px" align="center"><a href="ljclientes2.php?tipo=<?php  echo $tipo;?>&estadoe=0&datos=datos">
...
<?php }else{;?>
<td width="150px" align="center"><a href="ljclientes2.php?tipo=<?php  echo $tipo;?>&estadoe=1&datos=datos">
<span class="caja"><div style="position:relative"><img src="../img/<?php  echo $ic;?>" width="44px">
