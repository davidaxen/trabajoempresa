...
$result00=mysql_query ($sql00) or die ("Invalid result icarnet");
$row00=mysql_affected_rows();
if ($row00==0){
	$num_siniestro=1;
	}else{
$idsiniestro=mysql_result($result00,0,'idsiniestro');
...
$result01=mysql_query ($sql01) or die ("Invalid result clientes");
$nombrecli=mysql_result($result01,0,'nombre');
$domiciliocli=mysql_result($result01,0,'domicilio');
$provinciacli=mysql_result($result01,0,'provincia');
$localidadcli=mysql_result($result01,0,'localidad');
$cpcli=mysql_result($result01,0,'cp');
...
//echo $sql10;
$result10=mysql_query ($sql10) or die ("Invalid result trabajos");
...
//echo $sql1;
$result1=mysql_query ($sql1) or die ("Invalid result acctrabajos");
