...
$result1=mysql_query ($sql1) or die ("Invalid result insert2");
...
//echo $sql11;
$result11=mysql_query ($sql11) or die ("Invalid result select2");
$idinciplus=mysql_result($result11,0,'id');
...
$asuntoinci=mysql_result($result10,0,'asunto');
$idproveedor=mysql_result($result10,0,'idproveedor');
$idcomunidad=mysql_result($result10,0,'idpiscina');
$texto=mysql_result($result10,0,'texto');
...
$emailproveedor=mysql_result($result1,0,'email');
$emailadmin=mysql_result($result1,0,'emailadmin');
$nproveedor=mysql_result($result1,0,'nombre');
//echo $nemp."</br>";
...
$result2img=mysql_query ($sql2img) or die ("Invalid result 2");
$row2img=mysql_affected_rows();
//echo $emailgestor."</br>";				
							
for ($ty=0;$ty<$row2img;$ty++){;
$rf1=mysql_result($result2img,$ty,'imgsiniestro');
$textoimg=mysql_result($result2img,$ty,'texto');
